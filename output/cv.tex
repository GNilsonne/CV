...
\begin{enumerate}[nolistsep, label={[\arabic*]}]
    ...
    \item \{Smith R and Roberts I. Time for sharing data to become routine: the seven excuses for not doing so are all invalid [version 1; referees: 2 approved, 1 approved with reservations] F1000Research 2016, 5:781. doi: 10.12688/f1000research.8422.1. doi of review report: 10.5256/f1000research.9066.r14294\} \{Matthews PC. Fairness in scientific publishing [version 2; referees: 3 approved] F1000Research 2016, 5:2816. doi: 10.12688/f1000research.10318.2. doi of review report 1: 10.5256/f1000research.11114.r18242. doi of review report 2: 10.5256/f1000research.11479.r19405\} \{Rowhani-Farid A, Barnett AG. Badges for sharing data and code at Biostatistics: an observational study [version 1; referees: 1 approved] F1000Research 2018, 7:90. doi: 10.12688/f1000research.13477.1. doi of review report: 10.5256/f1000research.14635.r30171.\}
...
\begin{enumerate}[nolistsep, label={[\arabic*]}]
    ...
    \item Selenite induces apoptosis in malignant mesothelioma cells.. 2004.

    \item Selenite induces apoptosis in therapy resistant malignant mesothelioma cells.. 2005.
    ...
    \item Targeting thioredoxin reductase - a possible new treatment for malignant mesothelioma.. 2006.

    \item Nilsonne G et al. Title not on record. KI Cancer Retreat, Djurönäset 2007. Poster presentation.. 2007.

    \item Selenite-induced apoptosis signalling in differentially sensitive mesothelioma cell lines.. 2007.
    ...
    \item Effects of 25 mg Oxazepam on self-reported and psychophysiological measures of empathy.. 2012.

    \item Effects of 25 mg Oxazepam on self-reported and psychophysiological measures of empathy.. 2012.

    \item Effects of 25 mg Oxazepam on empathy: a behavioural study.. 2012.

    \item Psychopathic traits and the representation of others’ emotional states.. 2013.

    \item Pharmacological modulation of empathy using Oxazepam.. 2013.

    \item Effect of partial sleep deprivation on self-rated health and sickness.. 2013.

    \item Detection of facial mimicry by electromyography during fMRI scanning.. 2013.

    \item Effect of partial sleep deprivation on empathic responding in an fMRI experiment.. 2014.

    \item Effect of partial sleep deprivation on empathy for pain in an fMRI experiment.. 2014.

    \item Sleep Deprivation and Emotion – fMRI studies.. 2014.

    \item Effects of Sleep Deprivation on Emotional Processing Related to Others’ Emotional Expression and Experience.. 2015.

    \item It hurts me too: an fMRI study on the effects of experimental sleep restriction on empathy for pain in younger and older adults. 2016.

    \item Öppna, slutna och dolda data: erfarenheter av en metaanalys och synpunkter från en forskares horisont.. 2016. [\href{http://www.slideshare.net/kbredaktion/ppna-slutna-och-dolda-data-erfarenheter-av-en-metaanalys-och-synpunkter-frn-en-forskares-horisont-gustav-nilsonne}{slides} | \href{https://www.youtube.com/watch?v=jEfRBOV_KEA\&index=14\&list=PLZVkEICvA5-HRSSr5kb-hswTHUVag5c8P}{video}]

    \item The hidden costs of nudging: Experimental evidence from reminders in fundraising. 2016.
    ...
    \item Increased global fMRI signal variability after partial sleep deprivation: findings from the Stockholm Sleepy Brain study.. 2017.

    \item Interleukin-6: diurnal variation and relation to sleep.. 2017. [\href{https://osf.io/kd53f/}{slides}]

    \item Increased global fMRI signal variability after partial sleep deprivation: findings from the Stockholm Sleepy Brain study.. 2017.

    \item Workshop: IRB for open data.. 2017.

    \item Salvaging data: retrospective publication.. 2017.

    \item Incentivizing open data with badges.. 2017. [\href{https://osf.io/r7xv2/}{slides} | \href{https://www.youtube.com/watch?v=FztK2AG0W4Y&feature=youtu.be}{video}]

    \item The FAIR principles and global health research.. 2018. [\href{https://osf.io/2nxmr/}{slides}]

    \item Dissipating and cumulating research fields - new concepts for promoting data salvage.. 2018. [\href{https://osf.io/u7z23/}{slides}]

    \item Reproducerbarhet i psykologisk och psykiatrisk forskning - några exempel.. 2019. [\href{https://osf.io/5nt6s/}{slides}]

    \item Reproducerbarhet i psykologisk och psykiatrisk forskning - några exempel.. 2019. [\href{https://osf.io/n6mhf/}{slides}]

    \item Open data in research on humans – promises and challenges.. 2019. [\href{https://osf.io/ja4sr/}{slides}]

    \item Anonymization and secondary use of individual participant data.. 2020.

    \item Data sharing for scientific integrity - examples and frameworks.. 2020. [\href{https://osf.io/sz3wn/}{slides}]

    \item Ethics of FAIR in Neuroimaging.. 2021. [\href{https://osf.io/bswxp/ }{slides}]

    \item Data sharing for clinical research – challenges and opportunities. 2021. [\href{https://osf.io/4rgj3/}{slides}]

    \item Data domain specialists and flagship projects: challenges and successes in crafting partner contributions to the Swedish National Data Service consortium. 2022.

    \item Changing the publication system. 2022.

    \item Olika slutsatser från samma data - analytisk flexibilitet i medicinsk forskning. 2023. [\href{https://osf.io/fm7we}{slides}]

    \item EEGManyPipelines: A large-scale, grass-root multi-analyst study of EEG analysis practices. 2023. [\href{https://osf.io/zn2vf}{slides}]

    \item Risk Of Significant Error - A checklist to assess the risk of errors in statistical reporting and datasets. 2023.

    \item Ensuring DeSci results are reproducible and trustworthy. 2023. [\href{https://osf.io/z5amvh}{slides}]

    \item Research assessment as a lever to improve scientific practices. 2023. [\href{https://vimeo.com/showcase/10628629/video/862484008}{video}]

    \item Clinical trials reporting at Nordic medical universities and university hospitals. 2023. [\href{https://osf.io/z2cyn}{slides}]

    \item Coara – vad är det?. 2023. [\href{https://osf.io/2jw5n}{slides}]

    \item Big team science reproducibility collaborations and transnational initiatives. 2023. [\href{https://osf.io/b7v3y}{slides}]

    \item Risk Of Statistical Error - A checklist to assess the risk of errors in statistical reporting and datasets. 2023.
...
\begin{enumerate}[nolistsep, label={[\arabic*]}]
    ...
    \item Differential effects of selenite on malignant mesothelioma cells - a novel therapeutic approach related to the Trx-TrxR system and the redox state of the cells.. 2004.

    \item Effect of partial sleep deprivation on empathy for pain in an fMRI experiment.. 2014.

    \item Effects of partial sleep deprivation on the neural mechanisms of face perception.. 2014.

    \item Women sleep better and have a stronger response to late night curtailed sleep than men, particularly in older individuals-effects on polysomnographical sleep.. 2016.

    \item S13. Can Psychological Treatment Slow Down Cellular Aging in Social Anxiety Disorder? An Intervention Study Evaluating Changes in Telomere Length and Telomerase Activity.. 2018.

    \item 0149 Gray Matter Volume Correlates Of Sleepiness: A Voxel-based Morphometry Study In Younger And Older Adults.. 149.

    \item Sleepy Brain 2: Multimodal brain imaging after a night of sleep deprivation.. 2018. [\href{https://osf.io/vxmdj/}{slides}]
